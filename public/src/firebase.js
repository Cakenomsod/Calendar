...
import { getAuth, GoogleAuthProvider, signOut, signInWithPopup } from "https://www.gstatic.com/firebasejs/11.0.0/firebase-auth.js";
...
export { app, db, auth, provider, signInWithPopup, signOut, messaging, getToken, onMessage };
